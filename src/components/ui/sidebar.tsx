  ...
  return (
    <main
      ...
      className={cn(
        ...
        "md:peer-data-[variant=sidebar]:ml-[--sidebar-width] md:peer-data-[collapsible=icon]:peer-data-[variant=sidebar]:ml-[--sidebar-width-icon]",
        "md:transition-[margin-left,margin-right] md:ease-in-out md:duration-200",
        "md:peer-data-[variant=inset]:m-0 md:peer-data-[variant=inset]:rounded-none",
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      data-sidebar="header"
      className={cn("flex flex-col gap-2 p-4 pt-6", className)}
      {...props}
    />
  )
})
