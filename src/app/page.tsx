...
const features = [
    {
        ...
        description: "Creates a personalized daily schedule using your free time, subjects, tasks, and goals.",
        color: "blue"
    },
    {
        icon: Layers,
        title: "Flashcard Generator",
        description: "Turns your notes, PDFs, or even photos of notes into smart flashcards automatically.",
        color: "sky"
    },
    {
        icon: FileSignature,
        title: "Essay Analyzer",
        description: "Grades your essay on grammar, clarity, and structure, then provides a corrected rewrite.",
        color: "purple"
    },
    {
        icon: BarChart,
        title: "Learning Analytics",
        description: "Simple progress insights like study streaks and mastered cards to keep you motivated.",
        color: "green"
    }
];
    ...
    <section id="features" className="py-20 md:py-28 animate-in fade-in-50">
        <div className="container">
            <div className="text-center max-w-3xl mx-auto mb-12">
                ...
                <p className="mt-4 text-lg text-muted-foreground">Stop guessing. Start learning with AI-powered tools designed for academic success.</p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                {features.map(feature => (
                    <Card key={feature.title} className="text-center p-2 bg-card/50 backdrop-blur-sm border-border/50 hover:border-primary/50 hover:shadow-lg transition-all duration-300">
                        <CardHeader>
  ...
  <section id="how-it-works" className="py-20 md:py-28 bg-secondary/30 animate-in fade-in-50">
    <div className="container">
      <div className="text-center max-w-3xl mx-auto mb-16">
        ...
        <p className="mt-4 text-lg text-muted-foreground">Getting started is simple. Tell us what you need, and our AI does the rest.</p>
      </div>
      <div className="relative grid md:grid-cols-3 gap-8">
        ...
        <div className="relative flex flex-col items-center text-center">
          ...
          <h3 className="mt-4 text-xl font-semibold font-headline">Tell us your goals</h3>
          <p className="mt-2 text-muted-foreground">Input your subjects, upcoming exams, assignments, and available study time.</p>
        </div>
        <div className="relative flex flex-col items-center text-center">
            <div className="absolute top-1/2 w-full h-0.5 bg-border -translate-y-1/2 hidden md:block"></div>
            <div className="relative h-16 w-16 flex items-center justify-center rounded-full bg-background border-2 border-primary shadow-lg">
          ...
          <h3 className="mt-4 text-xl font-semibold font-headline">AI builds your engine</h3>
          <p className="mt-2 text-muted-foreground">Our AI analyzes your input to generate a personalized study plan and resources.</p>
        </div>
        <div className="relative flex flex-col items-center text-center">
            <div className="relative h-16 w-16 flex items-center justify-center rounded-full bg-background border-2 border-primary shadow-lg">
             <span className="text-2xl font-bold text-primary">3</span>
          </div>
          <h3 className="mt-4 text-xl font-semibold font-headline">Study with guidance</h3>
          <p className="mt-2 text-muted-foreground">Follow your daily plan, practice with AI flashcards, and track your progress.</p>
        </div>
      </div>
    </div>
  </section>
    ...
    <section id="pricing" className="py-20 md:py-28 animate-in fade-in-50">
        <div className="container">
            <div className="text-center max-w-3xl mx-auto mb-12">
                ...
                <p className="mt-4 text-lg text-muted-foreground">Our core features are free to use. Get your personal AI study partner today.</p>
            </div>
            <div className="flex justify-center">
                <Card className="max-w-md w-full shadow-2xl shadow-blue-500/10 dark:shadow-blue-500/5 border-2 border-primary">
                    <CardHeader className="text-center">
                        ...
                        <CardDescription>All the essentials to get you started.</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                        <ul className="space-y-3">
                           <li className="flex items-center gap-3"><CheckCircle className="h-5 w-5 text-green-500" /> AI Study Planner</li>
                           <li className="flex items-center gap-3"><CheckCircle className="h-5 w-5 text-green-500" /> Flashcard Generator</li>
                           <li className="flex items-center gap-3"><CheckCircle className="h-5 w-5 text-green-500" /> Essay Analyzer</li>
